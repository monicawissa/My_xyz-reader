...
private CoordinatorLayout mCoordinateLayout;
    ...
    public DynamicHeightNetworkImageView thumbnailVie;
    public TextView titleVie;
    public TextView subtitleVie;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCoordinateLayout = (CoordinatorLayout) findViewById(R.id.coordinator_article_list);
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        Snackbar snackbar = Snackbar
                .make(mCoordinateLayout, "Data loading completed !", Snackbar.LENGTH_LONG);
        snackbar.show();
    }
